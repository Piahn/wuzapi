...
func (s *server) routes() {
	...
	s.router.Handle("/chat/send/videostream", c.Then(s.SendMediaStream())).Methods("POST")
	s.router.Handle("/chat/send/mediastream", c.Then(s.SendMediaStream())).Methods("POST")
